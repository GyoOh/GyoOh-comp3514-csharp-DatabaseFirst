...
namespace newMVC.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public MemberController(BaragaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Members != null ? 
                          ...
                          Problem("Entity set 'BaragaContext.Members'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BaragaContext.Members'  is null.");
            }
            var member = await _context.Members.FindAsync(id);
            if (member != null)
            {
